...
const AboutMeCard = () => {
  ...
  const myIntroduction = statement.introduction.map((item) => {
    return (
      <p
        className={`text-center text-[14px] lg:text-xl lg:text-start text-gray-500 ${
          darkTheme ? tertiaryDarkTheme : null
        }`}
        key={item.id}
      >
        {item.description}
  ...
  return (
    <>
      <main
        className={`font-montserrat flex flex-col justify-center items-center mt-10`}
      >
        ...
        <section className='flex flex-col gap-10 lg:flex-row justify-center items-center my-10'>
          ...
          <div className='w-72 lg:w-[500px] text-md flex flex-col justify-center items-center lg:items-start gap-3 lg:gap-7'>
            <h2
              className={`w-[300px] text-xl text-center font-semibold lg:w-[600px] lg:text-start lg:text-3xl text-gray-700 ${
                darkTheme ? tertiaryDarkTheme : null
              }`}
            >
              {' '}
