  ...
  const projectCard = projects.map((item)=>{
      return (
        ...
        <Link to={item.url} key={item.id} target='_blank'>  
          <section className='border flex flex-col-reverse w-96 h-auto rounded-lg shadow-lg p-10 gap-10 lg:flex-row lg:w-[1200px] mx-20 hover:scale-105 transition duration-500 cursor-pointer'>  
        ...
        :
        <Link to={item.url} key={item.id} target='_blank'>  
        <section className='border flex flex-col w-96 h-auto rounded-lg shadow-lg p-10 gap-10 lg:flex-row lg:w-[1200px] mx-20 my-5 hover:scale-105 transition duration-500 cursor-pointer'>  
