...
const ContactForm = () => {
  ...
  return (
    <main
      className={`font-montserrat flex flex-col justify-center items-center gap-5 py-5`}
    >
      ...
      <form
        className={`border w-5/6 flex flex-col justify-center items-center gap-5 rounded-xl p-10 bg-[#fcfbfb83] lg:w-[800px] lg:flex-row lg:flex-wrap ${
