...
const Navbar = ({page}) => {
    const links = [{name:"HOMEPAGE",path:"/"},{name:"ABOUT ME",path:"/aboutme"},{name:"PROJECTS",path:"/projects"},{name:"RESUME",path:"/resume"},{name:"CONTACT",path:"/contact"}]
    ...
    <>
        ...
        <nav className={`p-14 flex justify-between items-center h-[30%] font-montserrat ${page !== "HomePage" ? `bg-mountain bg-top bg-cover shadow-md`:null}`}>
